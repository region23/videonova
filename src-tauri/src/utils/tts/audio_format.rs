...
/// # Возвращает
/// 
/// Кортеж из вектора PCM семплов и частоты дискретизации
...
/// # Возвращает
/// 
/// Кортеж из вектора с PCM-семплами (f32) и частоты дискретизации
...
/// # Аргументы
/// 
/// * `pcm_data` - Вектор с PCM-семплами (f32)
/// * `sample_rate` - Частота дискретизации
/// * `output_path` - Путь, куда будет сохранен WAV-файл
/// 
/// # Возвращает
/// 
/// Результат операции
...
/// Вычисляет среднеквадратичное (RMS) значение аудио-данных.
/// 
/// # Аргументы
/// 
/// * `samples` - Вектор с PCM-семплами (f32)
/// 
/// # Возвращает
/// 
/// RMS значение
